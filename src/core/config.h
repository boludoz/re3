...
#define XINPUT
#endif
#if defined XINPUT || (defined RW_GL3 && !defined LIBRW_SDL3 && !defined GTA_HANDHELD)
...
//#define AUDIO_OAL_USE_MPG123 // DISABLED - use mpg123 to support mp3 files - has POSIX issues on Windows
